...
from .rough_env_cfg import FanfanA1CleanRoughEnvCfg, FanfanA1CleanRoughEnvCfg_PLAY
...
@configclass
class FanfanRlCpgFlatEnvCfg(FanfanA1CleanFlatEnvCfg):
    pass


@configclass
class FanfanRlCpgFlatEnvCfg_PLAY(FanfanA1CleanFlatEnvCfg_PLAY):
    pass


@configclass
class FanfanRlCpgFlatEnvCfg_CPG_ONLY(FanfanA1CleanRoughEnvCfg_PLAY):
    def __post_init__(self) -> None:
        super().__post_init__()
        self.scene.terrain.terrain_type = "plane"
        self.scene.terrain.terrain_generator = None
